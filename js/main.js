...
const tests = {
  ...
  scq_vida: { obj: SCQ_TodaLaVida, target: ['child', 'teen'], label: 'TEA' }, // para el test clásico (lo que todo el mundo usa la primera vez)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!ageSelector || !testSelector || !container) {
    console.warn('Los elementos de prueba no se encontraron en el DOM');
    return;
  }
